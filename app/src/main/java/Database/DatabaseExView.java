...
public class DatabaseExView extends SQLiteAssetHelper {
    private static final String DB_NAME = "fitnessdb.db";
    private static final int DB_VER = 1;

    public DatabaseExView(Context context) {
    ...
    public void saveSettingMode(int value){
        SQLiteDatabase db = getReadableDatabase();
        String querry = "UPDATE Setting SET Mode = "+value;
        db.execSQL(querry);
    }
    ...
    public void saveDay(String value){
        SQLiteDatabase db = getReadableDatabase();
        String querry = String.format("INSERT INTO WorkoutDays(Day) VALUES('%s');",value);
        db.execSQL(querry);
    }
